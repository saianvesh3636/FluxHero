...
- [ ] Add sanity check assertions (backend/backtesting/engine.py) - assert equity never negative, position size <= max allowed, trades have valid entry < exit timestamps, P&L matches equity change.

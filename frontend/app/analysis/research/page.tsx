/**
 * Market Research Page - /analysis/research
 *
 * Ad-hoc stock research tool with technical indicators
 * (Moved from /analytics for better organization)
 */
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Technical analysis and performance metrics for any symbol"
      />
      ...
      <div className="flex items-center gap-6 mb-6">
        ...
        <div className="text-text-400 text-sm">
          Select a symbol to analyze its technical indicators and performance
        </div>
      </div>

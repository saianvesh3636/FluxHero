  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6 page-container">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Chart Container */}
        <div className="bg-gray-800 rounded-lg p-4 mb-6 chart-container card">
          {loading && (
            <div className="absolute inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-10">
              <div className="text-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-white mx-auto mb-4 loading-spinner"></div>
